...
router.get(
  "/customer/offer/:orderId/:id?",
  orderController.fetchrequestOrderOffers
);
...
router.put(
  ...
  admin,
  orderController.updatePurchasePaymentByAdmin
);
router.put(
  "/admin/update-payment/:id",
  admin,
  orderController.updatePaymentByAdmin
);
router.put(
  "/customer/pay/:id",
  orderController.updatePurchasePaymentByCustomer
);
